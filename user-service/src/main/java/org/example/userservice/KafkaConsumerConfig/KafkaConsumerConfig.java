package org.example.userservice.KafkaConsumerConfig;
...
public class KafkaConsumerConfig {
    @Bean
    public ConsumerFactory<String, SubscriptionEvent> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "org.example.subscriptionservice.model.SubscriptionEvent");
